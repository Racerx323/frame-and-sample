...
The security of `frame-and-sample` is a top priority. Your assistance is invaluable in helping to keep it secure.

## Supported Versions

Only the latest version of `frame-and-sample` is supported with security updates. Please ensure you are using the most recent release or code from the `main` branch.
...
I have enabled **[private vulnerability reporting](https://github.com/Racerx323/frame-and-sample/security/advisories/new)** for this project. This is the preferred and most secure way to report a vulnerability.
